...
class loginPage(BasePage):
    ...
    loginButton_element = (
        By.CSS_SELECTOR, '#basic > div.ant-row.ant-form-item._FormBottom_h5mzm_273 > div > div > div > button > span')
    into_element = (By.XPATH,
                    '//*[@id="ice-container"]/div/section/div[2]/main/div/div/div[2]/div/div/div/div[1]/ul/li[2]/div[2]/div[2]/span/img')
