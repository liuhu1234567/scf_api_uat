...
def api_template_api_accessHistory_download(token, payload):
    """准入历史数据列表下载"""
    url = f'{api_host}/api-scf-data/template/api/accessHistory/download'
    headers = {
        "Content-Type": "application/json;charset=UTF-8",
        "x-appid-header": "1",
        "Authorization": token
...
class TemplateApi(unittest.TestCase):
    def test_001_template_api_accessHistory_list(self):
        ...
        r = api_template_api_accessHistory_list(token_scf_platform, payload)
        r_json = r.json()
    ...
    def test_002_template_api_accessHistory_update(self):
        ...
        r = api_template_api_accessHistory_update(token_scf_platform, payload)
        r_json = r.json()
        restime_now = r.elapsed.total_seconds()
        customize_dict['restime_now'] = restime_now
        self.assertEqual(200, r_json['resp_code'])
    ...
    #         "tableId": 1562277848618438658
    #     }
    #     r = api_template_api_accessHistory_delete(token_scf_platform, payload)
    #     r_json = r.json()
    #     restime_now = r.elapsed.total_seconds()
    #     customize_dict['restime_now'] = restime_now
    #     self.assertEqual(200, r_json['resp_code'])
    ...
    # def test_004_template_api_accessHistory_download(self):
    #     """准入历史数据列表下载"""
    #     payload = {
    #         "coopCrLmt": 0,
    #         "coopMonths": 0,
    ...
    #         "vendorDeliveryFreq": 0
    #     }
    #     r = api_template_api_accessHistory_download(token_scf_supplier, payload)
    #     r_json = r.json()
    #     restime_now = r.elapsed.total_seconds()
    #     customize_dict['restime_now'] = restime_now
    #     self.assertEqual(200, r_json['resp_code'])
    ...
    # def test_005_template_api_zxLending_delete(self):
    #     """中信放款数据删除"""
    ...
    def test_006_template_api_zxLending_list(self):
        """中信放款数据列表"""
        payload = {
            "createBy": 0,
            "createTime": "",
        ...
        r = api_template_api_zxLending_list(token_scf_platform, payload)
        r_json = r.json()
        restime_now = r.elapsed.total_seconds()
        customize_dict['restime_now'] = restime_now
        self.assertEqual(200, r_json['resp_code'])
    ...
    def test_007_template_api_zxLending_update(self):
        """中信放款数据修改"""
        payload = {
            "createBy": 0,
            "createTime": "",
        ...
        r = api_template_api_zxLending_update(token_scf_platform, payload)
        r_json = r.json()
        restime_now = r.elapsed.total_seconds()
        customize_dict['restime_now'] = restime_now
        self.assertEqual(200, r_json['resp_code'])
