from case_api.login_password import api_login_password
...
def get_scf_financier():
    ...
    data = {
        ...
        "password": scf_financier['password'],
        "grant_type": "password",
        "clientId": "webApp",
        "clientSecret": "webApp",
        "isVerify": True
...
def get_scf_enterprise():
    ...
    data = {
        ...
        "password": scf_enterprise['password'],
        "grant_type": "password",
        "clientId": "webApp",
        "clientSecret": "webApp",
        "isVerify": True
...
def get_scf_supplier():
    ...
    data = {
        ...
        "password": scf_supplier['password'],
        "grant_type": "password",
        "clientId": "webApp",
        "clientSecret": "webApp",
        "isVerify": True
...
def get_scf_platform():
    ...
    data = {
        ...
        "password": scf_platform['password'],
        "grant_type": "password",
        "clientId": "webApp",
        "clientSecret": "webApp",
        "isVerify": True
...
def get_scf_subsidiaries():
    ...
    data = {
        ...
        "password": scf_subsidiaries['password'],
        "grant_type": "password",
        "clientId": "webApp",
        "clientSecret": "webApp",
        "isVerify": True
