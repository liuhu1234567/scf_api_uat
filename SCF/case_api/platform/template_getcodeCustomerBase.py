...
def api_template_getcodeCustomerBase(token, payload):
    """【平台方】批量邀请客户建档模板.xlsx"""
...
class TemplateGetcodeCustomerBase(unittest.TestCase):
    def test_template_getcodeCustomerBase(self):
        """【平台方】批量邀请客户建档模板.xlsx"""
        contact = get_name()
        entName = get_company()
        ...
        r = api_template_getcodeCustomerBase(token_scf_supplier, payload)
        r_json = r.json()
