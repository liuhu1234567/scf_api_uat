...
class BackAccountDelete(unittest.TestCase):
    def test_backAccount_delete(self):
        """【平台方】删除银行账户"""
        payload_one = {
            "bankAccountDebutNo": "12312123",
            "bankAccountName": "中国银行",
            "bankAccountNo": "123124123123",
            "bankAccountSite": "深圳支行",
            "bankAccountType": 0
        }
        id = api_backAccount_insert(token_scf_supplier, payload_one).json()["resp_msg"]
        payload = {"id": id}
