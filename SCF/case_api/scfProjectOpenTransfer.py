...
class ScfProjectOpenTransfer(unittest.TestCase):
    def test_001_scfProjectOpenTransfer_editOpenTransfer(self):
        ...
        coreId = api_scfProjectOpenTransfer_searchProjectOpenTransfer(token_scf_platform, payload).json()["datas"][0]["coreId"]
        payload_new = {
          "id": coreId
        }
    ...
    def test_005_scfProjectOpenTransfer_delete(self):
        ...
        r = api_scfProjectOpenTransfer_delete(token_scf_platform, payload)
        r_json = r.json()
        restime_now = r.elapsed.total_seconds()
        customize_dict['restime_now'] = restime_now
        self.assertEqual(200, r_json['resp_code'])
